...
<script>
// Fallback for browsers without Popover API (e.g., iOS 12 Safari)
if (!('showPopover' in HTMLElement)) {
  // Handle "Show Config" buttons (toggle)
    ...
    button.addEventListener('click', () => {
      ...
      if (popover) {
        if (popover.hasAttribute('hidden')) {
          ...
          // Optional: Add a class for basic overlay positioning if needed
          popover.style.position = 'absolute';
          popover.style.zIndex = '1000';
          popover.style.background = 'white';
          popover.style.border = '1px solid #ccc';
          popover.style.padding = '1rem';
          // Position relative to button (rough; tweak as needed)
  ...
  // Handle close buttons (always hide)
  document.querySelectorAll('.config-close').forEach(button => {
